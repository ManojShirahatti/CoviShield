    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.action_info:
                new AlertDialog.Builder(this)
                        ...
                        .setMessage("Source:\nhttps://www.worldometers.info/coronavirus\n" +
                                "\n\n" +
                                "Developer: Manoj Arunkumar Shirahatti (Manoj Dev)" +
                                "\n" +
                                "\n" +
                                "GitHub,Manoj")
                        .setPositiveButton("Close", null)
            ...
            case R.id.action_share:
                ...
                String shareBody = "Install (CoviShield) Android Application to get the latest " +
                        "global updates for Coronavirus Outbreak\nLink" +
                        "\n\n" +"Manoj Shirahatti";
                sharingIntent.putExtra(android.content.Intent.EXTRA_SUBJECT, "CoviShield ");
                sharingIntent.putExtra(android.content.Intent.EXTRA_TEXT, shareBody);
                startActivity(Intent.createChooser(sharingIntent, "Share CoviShield Link"));
                return true;
            default:
